...
static void ipc_tx_next_msg(struct work_struct *work)
{
	...
	/* send message if HW read and mesage in TX list */
...
/* get stream postion IPC - use faster MMIO method if available on platform */
